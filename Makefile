all:
	gcc -rdynamic `pkg-config --cflags gtk+-3.0` ./src/main.c ./src/builder.c ./src/book-add.c ./src/book-edit.c ./src/log-add.c --output ./build/bookr.out `pkg-config --libs gtk+-3.0`
